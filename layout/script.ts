      ...
      // add txt
      {
        const The_Infinitys_txt: Function = (): HTMLElement => {
          ...
          htmlAttributes(inf_txt, [
            { name: "class", value: "The-Infinitys-txt" },
            { name: "viewbox", value: "0 0 623.301 101.001" },
            { name: "xmlns", value: "http://www.w3.org/2000/svg" },
          ]); // <svg class="The-Infinity-txt" viewbox="0 0 623.301 101.001" xmlns="http://www.w3.org/2000/svg">
          inf_txt.innerHTML = `
