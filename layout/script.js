    ...
    var client = function () {
        var select_bg = function () {
            ...
            var bg_func = {
                ...
                wallpaper: {
                    infinite: function () {
                        var wallpaper_infinite = document.querySelector('#BackGround>div[data-background-name="wallpaper-infinite"]');
